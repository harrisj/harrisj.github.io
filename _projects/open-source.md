...
![The NYT Open logo features a finite-state-machine-like diagram <](/static/images/projects/open-source/openNYT-logo.gif)
...
I was particularly proud of our logo, inspired by a finite-state machine diagram I had in the [Red Dragon compiler book](https://en.wikipedia.org/wiki/Compilers:_Principles,_Techniques,_and_Tools) I kept at my desk. I also am not sure who thought of the tagline "All The News That's Fit to Printf," but it was brilliant.
...
- [Trump Data](https://github.com/harrisj/trump_data) - a collection of datasets related to Trump (2025)
...
- [NYT Haiku Python](https://github.com/harrisj/nyt-haiku-python) - a rework of the original NYT haiku code in Python to run as a Twitter bot (2020 - 2022)
...
- [airport_scraper](https://github.com/harrisj/airport_scraper) - some Ruby code to extract airport info from freeform text, used in a project that looked for people posting travel on Twitter (2009 - 2010)
-  [tweetftp](https://github.com/nytimes/tweetftp) - an April Fool's joke where I implemented a system for sending a file via Twitter as a serious of small tweets
- [lifeline](https://github.com/nytimes/lifeline) - a cron-based approach for launching and keeping daemons alive
